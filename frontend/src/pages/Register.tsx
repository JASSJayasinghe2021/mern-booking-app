        ...
        <form className="flex flex-col gap-5" onSubmit={onSubmit}>
            ...
            <div className="flex flex-col md:flex-row gap-5">
                ...
                <label className="text-gray-700 text-sm font-bold">
                    Password
                    <input className="border rounded w-full py-1 px-2 font-normal" {...register("password", {required:"This field is required", minLength:{value:6, message:"Password must be at least six characters"}})}></input>
                    {errors.password && (
